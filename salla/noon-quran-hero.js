(function() {
  ...
  function render() {
    ...
    h.setAttribute('aria-label', 'مجموعة نون التعليمية');
    ...
    h.addEventListener('click', e => {
      if (e.target.tagName !== 'A') window.location.href = PRODUCT_URL;
    });
  }
